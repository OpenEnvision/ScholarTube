...
const directionDefinitions = [
  ...
  },
  {
    ...
    number: '05',
    label: 'Other',
    copy: 'Foundations, systems, industry, social impact, and adjacent AI research.',
  },
]
    ...
    <section className="directions" id="directions">
      <div className="shell">
        <div className="section-heading section-heading--row">
          ...
          <p>Five directions form a path into the index, including a broader lane for foundations, systems, industry, and social impact.</p>
        </div>
