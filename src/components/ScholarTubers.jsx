...
const profileDefinitions = [
  { name: 'Jensen Huang', role: 'Accelerated computing & AI systems', topic: 'AI Systems' },
  { name: 'Andrej Karpathy', role: 'Deep learning educator & builder', topic: 'Foundations' },
  { name: 'Lex Fridman', role: 'Research interviewer & podcaster', topic: 'Long-form interviews' },
  { name: 'Demis Hassabis', role: 'AI researcher & lab leader', topic: 'World Models' },
  ...
  { name: 'Sergey Levine', role: 'Robot learning researcher', topic: 'Robotics' },
  { name: 'Alexander Amini', role: 'Deep learning educator & researcher', topic: 'Foundations' },
  { name: 'Brian Yu', role: 'Computer science educator', topic: 'Foundations' },
  { name: 'Christopher Manning', role: 'NLP researcher & educator', topic: 'NLP' },
  { name: 'Emma Brunskill', role: 'Reinforcement learning researcher', topic: 'Agents' },
  { name: 'Russ Tedrake', role: 'Robotics researcher & educator', topic: 'Robotics' },
  { name: 'Fei-Fei Li', role: 'Computer vision researcher', topic: 'Vision' },
  { name: 'Yuandong Tian', role: 'AI researcher & technical leader', topic: 'Research Frontiers' },
  { name: 'Kai-Fu Lee', role: 'AI author, investor & industry leader', topic: 'Industry' },
  { name: 'Song Han', role: 'Efficient AI systems researcher', topic: 'AI Systems' },
