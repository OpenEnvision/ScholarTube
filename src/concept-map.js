...
export const CONCEPT_CLUSTERS = [
  {
    ...
    concepts: [
      ...
      { id: 'transformers', label: 'Transformers', query: 'transformer', blurb: 'Attention, context, and the architecture under most large models.', after: ['neural-networks'] },
    ],
  },
  {
    id: 'Agent',
    ...
    concepts: [
      ...
      { id: 'rlhf', label: 'RLHF', query: 'rlhf', blurb: 'Learning from human feedback and preference optimization.', after: ['alignment'] },
  ...
  },
  {
    ...
    concepts: [
      ...
      { id: 'multimodal', label: 'Multimodal models', query: 'multimodal', blurb: 'Joining vision and language in one model.', after: ['foundation-models'] },
    ],
  },
  {
    id: 'Robotics',
